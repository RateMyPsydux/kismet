...
kis_datasource_gnumac::kis_datasource_gnumac(shared_datasource_builder in_builder) :
...
kis_datasource_gnumac::~kis_datasource_gnumac() {

}

void kis_datasource_gnumac::open_interface(std::string in_definition, unsigned int in_transaction,
        open_callback_t in_cb) {
    kis_datasource::open_interface(in_definition, in_transaction, in_cb);
}

#if 0
int kis_datasource_gnumac::httpd_post_complete(kis_net_httpd_connection *concls) {
